		...
		synchronized (this) {
			while (true) {
				if (logger.isDebugEnabled()) {
					logger.debug("Heart beat checking , now health count : " + healthCount + " , unHealth count : "
							+ unHealthCount);
				}
				System.out.println("Heart beat checking , now health count : " + healthCount + " , unHealth count : "
						+ unHealthCount);

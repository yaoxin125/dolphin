...
public class ScannerInvoker extends AbstractInvoker {
	...
	@Override
	public Object invoke(String className, String methodName, Object[] parameters, Class<?>[] parameterTypes)
	...
	@Override
	public Object invoke(String className, String implementName, String methodName, Object[] parameters,
